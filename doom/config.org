...
(save-pdf-to-bib "/tmp/qutebrowser-downloads-cnl95d7j/tmp5c28pc7__PhysRevB.108.155404.pdf")
#+end_src
...
(defun doi-of-pdf (filename)
    (let* ((res (shell-command-to-string (concat "/home/stuart/miniconda3/bin/pdf2doi " filename))))
