...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. mod1Mask , xK_0), spawn "alacritty")
    , ((modm .|. mod1Mask , xK_9), spawn "emacsclient -c -e '(dashboard-mode)'")
    , ((modm .|. mod1Mask , xK_8), spawn "qutebrowser")
    , ((modm .|. mod1Mask , xK_7), spawn "flatpak run com.spotify.Client")
